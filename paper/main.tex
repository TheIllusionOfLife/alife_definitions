...
\newcommand{\aucDci}[1]{%
  ...
  \ifthenelse{\equal{#1}{D2}}{[0.61,\,0.69]}{%
  \ifthenelse{\equal{#1}{D3}}{[0.74,\,0.79]}{%
  \ifthenelse{\equal{#1}{D4}}{[0.76,\,0.80]}{??}}}}}
...
\begin{tikzpicture}[
    ...
    lvl/.style={draw, dashed, rounded corners, inner sep=6pt, gray},
    arr/.style={->, thick},
]
% World level
...
\end{tikzpicture}
\caption{Two-layer substrate architecture.  The world provides
...
($\rho = $ \rhoDD{D1D3}, CI: \rhoDDci{D1D3}).
D3 and D4 show the lowest $\kappa$ (\kappaDD{D3D4},
CI: \kappaDDci{D3D4}), as organizational closure and information
maintenance capture fundamentally different aspects.
The D1--D3 pair shows moderate agreement
($\kappa = $ \kappaDD{D1D3}, CI: \kappaDDci{D1D3}),
while D2--D4 is weaker ($\kappa = $ \kappaDD{D2D4},
CI: \kappaDDci{D2D4}).
...
(ROC-AUC = \aucD{D1}, 95\% CI: \aucDci{D1}),
followed by D4 (\aucD{D4}, CI: \aucDci{D4}) and D3
(\aucD{D3}, CI: \aucDci{D3}).
D2 shows the lowest AUC (\aucD{D2}, CI: \aucDci{D2}), likely because its three
