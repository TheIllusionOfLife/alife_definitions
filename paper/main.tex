...
\caption{ROC curves on held-out test seeds (100--199).}
\label{fig:roc}
\end{figure}
...
D1's seven criteria capture the broadest signal (AUC = \aucD{D1}),
followed by D4 (\aucD{D4}), D3 (\aucD{D3}), and D2 (\aucD{D2}).
